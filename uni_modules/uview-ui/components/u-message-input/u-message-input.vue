<template>
	<view class="u-char-box">
		<view class="u-char-flex" style="display: flex;">
			<input :disabled="disabledKeyboard" :value="valueModel" type="number" :focus="focus" :maxlength="maxlength"
				class="u-input" @input="getVal" />
			<div class="dis al_c">
				...
				mode === 'box' ? 'u-box' : '']" :style="{
					...
					borderColor: charArrLength === index && mode == 'box' ? activeColor : inactiveColor
						...
						<view class="u-placeholder-line" :style="{
							...
							height: height * 0.5 +'rpx'
						}" v-if="mode !== 'middleLine'"></view>
